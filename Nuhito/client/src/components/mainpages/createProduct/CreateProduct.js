                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div className="upload">
                                    <input type="file" name="image1" class="file_up1" onChange={(e) => handleUpload(e, setImage1, setLoading1)}/>
                                    {
                                        loading1 ? <div class="file_img1"></div>
                                        :<div class="file_img1" style={{display: image1 ? "block" : "none"}}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div className="upload">
                                    <input type="file" name="image2" class="file_up2" onChange={(e) => handleUpload(e, setImage2, setLoading2)}/>
                                    {
                                        loading2 ? <div class="file_img2"></div>
                                        :<div class="file_img2" style={{display: image2 ? "block" : "none"}}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div className="upload">
                                    <input type="file" name="image3" class="file_up3" onChange={(e) => handleUpload(e, setImage3, setLoading3)}/>
                                    {
                                        loading3 ? <div class="file_img3"></div>
                                        :<div class="file_img3" style={{display: image3 ? "block" : "none"}}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div className="upload">
                                    <input type="file" name="image4" class="file_up4" onChange={(e) => handleUpload(e, setImage4, setLoading4)}/>
                                    {
                                        loading4 ? <div class="file_img4"></div>
                                        :<div class="file_img4" style={{display: image4 ? "block" : "none"}}>
